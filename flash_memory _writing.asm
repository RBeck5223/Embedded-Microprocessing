...
flashd:
                ...
                DC.B     $30,$33,$33,$37,$CF,$31,$00,$CE
                DC.B     $60,$00,$A6,$30,$07,$13,$A6,$30     ;for HCS12C128 board
...
msg1            DC.B     'Well', $00
msg2            DC.B     'Flash memory writing, 40 bytes at $6000', $00
msg3            DC.B     'Done. Reset and type go 6004 to check', $00     ;for HCS12C128 board
...
Entry
                 ...
                 staa    PPAGE            ; needed if $8000, not needed for $6000
                 
                 jsr     fclkset          ; set flash memory clock
                 jsr     dly1s
                 jsr     ferase           ; erase 1024 byte sector from $6000
                 jsr     dly1s
                 jsr     fwr40b           ; write 40 bytes to flash, starting at $6000
...
ferase:
                 ldx     #$6000           ; point to flash memory
                 ldaa    #$06             ; load dummy value
                 staa    0,X              ; store in flash
                 
                 ldaa    #$40             ; set command as "sector erase"
                 staa    FCMD
                 
                 ldaa    #%10000000      ; clear CBEIF, by writing 1
                 staa    FSTAT           ; start sector erase operation
...
fwr40b_p1:
                 ...
                 ldx     #$6000          ; set flash memory address pointer
...
;* this code will be programmed into Flash ROM starting at $6004
;**********************************************
                 nop
                 nop
                 nop
...
; DC.B $F9,$4F,$CC,$80,$FC,$5A,$CF,$3D
;
;* after flash programming, when the program at $6004 is ran,
